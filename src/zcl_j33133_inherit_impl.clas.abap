CLASS zcl_j33133_inherit_impl DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_j33133_inherit_impl IMPLEMENTATION.
...
*================================================================================================,
    ...
    DATA plane_a383 TYPE REF TO lcl_passenger_plane.

    plane_a383 = NEW #( iv_manufacturer = 'bowing' iv_seats = 123 iv_type = 'AA' ).
    DATA(attributes) = plane_a383->get_attributes(  ).
