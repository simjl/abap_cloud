CLASS zcl_j33133_proc_func DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_j33133_proc_func IMPLEMENTATION.


  METHOD if_oo_adt_classrun~main.

    DATA text TYPE string      VALUE ` SAP BTP,   ABAP Environment  `.
    DATA text2 TYPE string     VALUE `_SAP_BTP,  _ABAP_Environment  `.
...
**********************************************************************
    ...
    out->write( |TO_MIXED2         = {  to_mixed(  text2 ) } | ).
