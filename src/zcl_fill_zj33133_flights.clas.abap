CLASS zcl_fill_zj33133_flights DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_fill_zj33133_flights IMPLEMENTATION.
...
*Add 50 new connection numbers and 2000 days of flights for each
    ...
    INSERT ZJ33133_flights FROM TABLE @insert_tab.
    out->write( |Generated { sy-dbcnt } rows in table ZJ33133_flights| ).
